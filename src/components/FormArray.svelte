...
<form>
    ...
    {#each $form.users as user, j}
        <div class="form-group">
            <div>
                <input name={`users[${j}].name`} placeholder="name" class="form-field" on:change={handleChange} on:blur={handleChange} bind:value={$form.users[j].name} />
            ...
            <div>
                <input name={`users[${j}].email`} placeholder="email" class="form-field" on:change={handleChange} on:blur={handleChange} bind:value={$form.users[j].email} />
