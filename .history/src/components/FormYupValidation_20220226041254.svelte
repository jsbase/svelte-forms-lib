...
<form>
    {#each $form.users as user, j}
        <div class="form-group">
            <div>
                <input placeholder="name" name={`user.nameyup`}
                    on:change={handleChange} on:blur={handleChange} bind:value={user.nameyup}/>
            ...
            <div>
                <input placeholder="email" name={`user.emailyup`}
                    on:change={handleChange} on:blur={handleChange} bind:value={user.emailyup} />
