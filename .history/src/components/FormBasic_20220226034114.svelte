...
<form on:submit={handleSubmit}>
	...
	<input id="name-basic" name="name-basic" on:change={handleChange} bind:value={$form.nameBasic} />

	<label for="email-basic" class="form-label">E-Mail</label>
	<input id="email-basic" name="email-basic" on:change={handleChange} bind:value={$form.emailBasic} />
